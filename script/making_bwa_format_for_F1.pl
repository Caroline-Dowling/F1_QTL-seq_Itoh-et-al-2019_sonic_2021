...
$ref_fasta_name=~s/\S+\///;
my $simbolic_link_txt="ex_for_link_".$F1_reads_txt_rename;
...
print "$read_count\n";
    if ($file =~ /^#/){
        ...
        print OUTPUT1 "links/bwa aln ../Parent_A_ref_seq_development/Parent_A_ref.fa links/${read_count}_1.fastq >F1_temp_${read_count}_1.sai\n";
        print OUTPUT1 "links/bwa aln ../Parent_A_ref_seq_development/Parent_A_ref.fa links/${read_count}_2.fastq >F1_temp_${read_count}_2.sai\n";
        print OUTPUT2 "links/bwa sampe ../Parent_A_ref_seq_development/Parent_A_ref.fa F1_temp_${read_count}_1.sai F1_temp_${read_count}_2.sai links/${read_count}_1.fastq links/${read_count}_2.fastq>F1_temp_${read_count}.sam\n";
        print OUTPUT3 "links/samtools view -bS F1_temp_${read_count}.sam> F1_temp_${read_count}.bam\n";
    }
}
close (FILE1);
#############################################################
